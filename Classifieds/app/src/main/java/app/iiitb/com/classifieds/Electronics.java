...
public class Electronics extends AppCompatActivity {
    ...
    private getElectronicsTask mElectronicsTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mElectronicsTask = new getElectronicsTask();
        mElectronicsTask.execute();
    }
    public class getElectronicsTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            if(s == null)
            {
                Log.d("Electronics", "Some error has occurred at Server");
                Toast.makeText(Electronics.this,"No posts to show",Toast.LENGTH_LONG).show();
            }

            else
            {
                Log.d("Electronics", "Displayed succesfully");
                //Log.d("Data", s);
                ...
                try {
                    ...
                    ArrayAdapter<PostDetails> adapter = new AllPostsArrayAdapter(Electronics.this, 0, pd);
                    ListView listView = (ListView) Electronics.this.findViewById(R.id.customListView);
