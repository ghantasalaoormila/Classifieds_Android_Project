...
public class Events extends AppCompatActivity {
    ...
    private getEventsTask mEventsTask;
    ...
    public class getEventsTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String...params){
            ...
            try {
                ...
                jsonObject.put("Category", "Events");
        ...
        protected void onPostExecute(String s) {
            if(s == null)
            {
                Log.d("Events", "Some error has occurred at Server");
                Toast.makeText(Events.this,"No posts to show",Toast.LENGTH_LONG).show();
            }

            else
            {
                Log.d("Events", "Displayed succesfully");
                //Log.d("Data", s);
                ...
                try {
                    ...
                    ArrayAdapter<PostDetails> adapter = new AllPostsArrayAdapter(Events.this, 0, pd);
                    ListView listView = (ListView) Events.this.findViewById(R.id.customListView);
