...
public class Vehicles extends AppCompatActivity {
    ...
    private getVehiclesTask mVehiclesTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVehiclesTask = new getVehiclesTask();
        mVehiclesTask.execute();
    }
    public class getVehiclesTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String...params){
            ...
            try {
                ...
                jsonObject.put("Category", "Vehicles");
        ...
        protected void onPostExecute(String s) {
            if(s == null)
            {
                Log.d("Vehicles", "Some error has occurred at Server");
                Toast.makeText(Vehicles.this,"No posts to show",Toast.LENGTH_LONG).show();
            }

            else
            {
                Log.d("Vehicles", "Displayed succesfully");
                //Log.d("Data", s);
                ...
                try {
                    ...
                    ArrayAdapter<PostDetails> adapter = new AllPostsArrayAdapter(Vehicles.this, 0, pd);
                    ListView listView = (ListView) Vehicles.this.findViewById(R.id.customListView);
