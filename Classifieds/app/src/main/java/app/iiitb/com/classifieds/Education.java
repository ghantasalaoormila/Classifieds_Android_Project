...
public class Education extends AppCompatActivity {
    ...
    private getEducationTask mEducationTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEducationTask = new getEducationTask();
        mEducationTask.execute();
    }
    public class getEducationTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String...params){
            ...
            try {
                ...
                jsonObject.put("Category", "Education");
        ...
        protected void onPostExecute(String s) {
            if(s == null)
            {
                Log.d("Education", "Some error has occurred at Server");
                Toast.makeText(Education.this,"No posts to show",Toast.LENGTH_LONG).show();
            }

            else
            {
                Log.d("Education", "Displayed succesfully");
                //Log.d("Data", s);
                ...
                try {
                    ...
                    ArrayAdapter<PostDetails> adapter = new AllPostsArrayAdapter(Education.this, 0, pd);
                    ListView listView = (ListView) Education.this.findViewById(R.id.customListView);
