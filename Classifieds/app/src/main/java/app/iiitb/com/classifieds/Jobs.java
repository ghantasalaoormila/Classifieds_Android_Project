...
public class Jobs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mJobsTask = new getJobsTask();
        mJobsTask.execute();
    }
    public class getJobsTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            if(s == null)
            {
                Log.d("Jobs", "Some error has occurred at Server");
                Toast.makeText(Jobs.this,"No posts to show",Toast.LENGTH_LONG).show();
            }

            else
            {
                Log.d("Jobs", "Displayed succesfully");
                //Log.d("Data", s);
                ...
                try {
                    ...
                    ArrayAdapter<PostDetails> adapter = new AllPostsArrayAdapter(Jobs.this, 0, pd);
                    ListView listView = (ListView) Jobs.this.findViewById(R.id.customListView);
