...
public class Services extends AppCompatActivity {
    ...
    private getServicesTask mServicesTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mServicesTask = new getServicesTask();
        mServicesTask.execute();
    }
    public class getServicesTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String...params){
            ...
            try {
                ...
                jsonObject.put("Category", "Services");
        ...
        protected void onPostExecute(String s) {
            if(s == null)
            {
                Log.d("Services", "Some error has occurred at Server");
                Toast.makeText(Services.this,"No posts to show",Toast.LENGTH_LONG).show();
            }
            ...
            else
            {
                ...
                try {
                    ...
                    ArrayAdapter<PostDetails> adapter = new AllPostsArrayAdapter(Services.this, 0, pd);
                    ListView listView = (ListView) Services.this.findViewById(R.id.customListView);
