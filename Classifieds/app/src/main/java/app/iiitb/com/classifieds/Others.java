...
public class Others extends AppCompatActivity {
    ...
    private getOthersTask mOthersTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOthersTask = new getOthersTask();
        mOthersTask.execute();
    }
    public class getOthersTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String...params){
            ...
            try {
                ...
                jsonObject.put("Category", "Others");
        ...
        protected void onPostExecute(String s) {
            if(s == null)
            {
                Log.d("Others", "Some error has occurred at Server");
                Toast.makeText(Others.this,"No posts to show",Toast.LENGTH_LONG).show();
            }

            else
            {
                Log.d("Others", "Displayed succesfully");
                //Log.d("Data", s);
                ...
                try {
                    ...
                    ArrayAdapter<PostDetails> adapter = new AllPostsArrayAdapter(Others.this, 0, pd);
                    ListView listView = (ListView) Others.this.findViewById(R.id.customListView);
